        ...
        <div class="row">
            <div class="card px-0">
                <div class="card-header">
                    <div class="text-dark font-weight-bold">Data Admin</div>
                </div>
                <div class="card-body">
                    <x-alert />
                ...
                <form id="form" action="/admin" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-outline mb-3">
                            <label for="idadmin" class="col-form-label">{{ __('Id Admin') }}<span
                                    class="text-danger">*</span></label>

                            <input id="idadmin" type="text" class="form-control @error('idadmin') is-invalid @enderror"
                                name="idadmin" required autofocus>
