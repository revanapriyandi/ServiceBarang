    ...
    public function run(): void
    {
        DB::table('kategoris')->insert([
            [
                'id' => 1,
                'name' => 'Selesai',
                'description' => 'Proses servis sudah selesai dengan kondisi bagus.',
            ...
            [
                'id' => 2,
                'name' => 'AWP',
                'description' => 'Proses servis sudah membelikan komponen namun sulit ditemukan.',
            ...
            [
                'id' => 3,
                'name' => 'OOC',
                'description' => 'Proses servis sedang berlangsung dan sedang menunggu komponen.',
            ...
            [
                'id' => 4,
                'name' => 'Unrepair',
                'description' => 'Barang tidak dapat diperbaiki',
